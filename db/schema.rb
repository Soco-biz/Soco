...
ActiveRecord::Schema.define(version: 20180527043516) do
  ...
  create_table "soco_posts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer "reply"
    t.integer "good", default: 0
    t.bigint "first_tag_id_id"
    t.bigint "second_tag_id_id"
    t.bigint "third_tag_id_id"
    t.float "latitude", limit: 24, null: false
    t.float "longitude", limit: 24, null: false
    t.text "image"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["first_tag_id_id"], name: "index_soco_posts_on_first_tag_id_id"
    t.index ["second_tag_id_id"], name: "index_soco_posts_on_second_tag_id_id"
    t.index ["third_tag_id_id"], name: "index_soco_posts_on_third_tag_id_id"
  end
